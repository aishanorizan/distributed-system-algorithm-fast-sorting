public class LoadBalancingServer
{
	...
	{	
		...
		//------------------------------------------------------------------------------------------	
		int completeUnsortedArray[] = new int[100000]; //Create all numbers to be distributed
		...
		//Load integers into the complete array
		for (int i=0; i<100000; i++) 
		{	
			completeUnsortedArray[i] = numberArray[i];
		}
